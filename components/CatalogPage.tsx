...
interface CatalogPageProps {
    ...
    side?: 'left' | 'right'; // Used by HTMLFlipBook internally
...
export const CatalogPage = React.memo(forwardRef<HTMLDivElement, CatalogPageProps>(({ page, side: _side, accessToken, onPageClick, highlightTerm, isVisible = true }, ref) => {
    ...
    // Declare handleImageError before useEffect to fix hoisting issue
    const handleImageError = useCallback(() => {
        if (!isFallback) {
            setImageSrc(FALLBACK_LOGO);
            setIsFallback(true);
        }
    }, [isFallback, FALLBACK_LOGO]);
    ...
    }, [page.image, accessToken, page.type, isVisible, FALLBACK_LOGO, handleImageError]);
